...
order: List[ItemElement] = [Tort("Красный бархат", 10.1),
                            Coffee("Латте малый", 5, 0.3),
                            Tort("Черный лес", 9.5),
                            Coffee("Капучино большой", 4, 0.5),
                            Tort("Чизкейк", 11.9),
                            Tort("Москва", 15.2)]
...
n=1
while n==1:
    print("На что требуется скидка: Без скидки, Торт, Кофе, На всё")
    vibor=input()
    while vibor not in ("Без скидки", "Торт", "Кофе", "На всё"):
        print("Ошибка! Повторите ввод с заглавной буквы")
        vibor=input()
